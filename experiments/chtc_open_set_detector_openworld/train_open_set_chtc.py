...
def main():
    ...
    # Stage 1 triage: human vs known-LLM vs unknown. Stage 2 runs known_model_clf only when stage 1 predicts LLM.
    log_print("Training stage-1 triage classifier: human vs LLM vs unknown...")
