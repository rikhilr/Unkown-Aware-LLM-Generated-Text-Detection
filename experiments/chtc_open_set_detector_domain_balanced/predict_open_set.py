...
def predict(text, artifact_dir):
    ...
    result = {
        ...
        "energy_gate_strategy": meta.get("primary_energy_gate_strategy", "unknown"),
        "energy_gate_max_known_false_unknown": meta.get("primary_energy_gate_max_known_false_unknown"),
