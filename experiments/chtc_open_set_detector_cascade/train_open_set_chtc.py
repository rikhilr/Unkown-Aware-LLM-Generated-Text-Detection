...
def evaluate_human_energy_known_pipeline(
    ...
    metrics = {
        ...
        f"{prefix}/gate/known_correct_final_rate": float(np.mean(known_final == y_known.astype(str))) if n_k else float("nan"),
...
def main():
    ...
    primary_energy_threshold = val_bundle["energy_threshold"]
